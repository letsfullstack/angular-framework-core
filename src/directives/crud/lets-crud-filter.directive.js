			...
			link: function (scope, $el) {
				...
				scope.autocomplete = function (field, val) {
					...
					if (field.customOptions.general !== undefined) {
						scope.resource.customGET('general/autocomplete/' + field.customOptions.general + '/' + val, queries).then(
							function (data) {
								deferred.resolve(data);
							},
						...
						scope.resource.customGET(route, queries).then(
							function (data) {
								// if (field.customOptions.select == true) {
